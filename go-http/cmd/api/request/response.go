...
func init() {
	errorCounterMonitor = prometheus.NewCounter("http_api_error_count_monitor",
		"http api error count monitor", []string{"uri"})
	succCounterMonitor = prometheus.NewCounter("http_api_succ_count_monitor",
		"http api success count monitor", []string{"uri"})
}
